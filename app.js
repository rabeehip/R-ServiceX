/*! jQuery v3.4.1 | (c) JS Foundation and other contributors | jquery.org/license & © rabeehip */
!(function (e, t) {
  "use strict";
...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="../css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="../css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="../css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="../css/nexmoe_v2.min.css">'
  );
}
document.write(
  ...
  var search_bar = `<div class="mdui-toolbar-spacer"></div>
        <div id="search_bar" class="mdui-textfield mdui-textfield-expandable mdui-float-right ${
          model.is_search_page ? "mdui-textfield-expanded" : ""
            ...
            <input class="mdui-textfield-input" type="text" name="q" placeholder="Search file(s)..." value="${search_text}"/>
            </form>
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-video-fluid mdui-center">
	  <video id="video-id" class="video-js vjs-default-skin" controls preload="none" width="100%" height="auto">
...
<button onclick="location.href='${url}'" title="Download Content" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent" aria-label="Download">
  ...
  const player = videojs('video-id', {
    ...
    poster: "../images/favicon.png", // Shown before playback starts
...
<div class="mdui-container-fluid">
	<br>
	<div class="mdui-video-fluid mdui-center">
	  <audio id="audio-id" class="video-js vjs-default-skin" controls preload="none" width="100%" height="auto">
