...
const authConfig = {
  "siteName": "R-Service™ 🔥", // WebSite Name
  "siteIcon": "../images/favicon.png", //or fevicon-x-light.png
...
// client_id & client_secret - PLEASE USE YOUR OWN!
  "client_id": "571539049208-ak201ue3oi5s486oeqdjm28qlhf2u1uh.apps.googleusercontent.com", // Client ID
  "client_secret": "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", // Client Secret
  "refresh_token": "1//0eb7CbMPzvFcXCgYIARAAGA4SNwF-L9Irf8aSMt9fTEMuL-YkouhW47R72fELjRAk9ox09cTXppmkyLPIVlzbWg6k0LWaQkYFqnU", // Refresh Token
...
const uiConfig = {
  ...
  "helpURL": "https://t.me/officialrservicebot", // Provide the URL of the help page(instructions for using the index). Leave this empty if you want to hide the help icon. Providing a URL will open the help page in a new tab. (You can use telegra.ph to write instructions)
  "footer_text": `© 2026 ‧ R-Service. All rights reserved ♥️`, // Provide the footer text. Leave this empty if you want to hide it.
