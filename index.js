...
*/
const authConfig = {
  siteName: "x...", // Website display name
  siteIcon: "xxx...", // Favicon URL or file name (e.g., fevicon-x-light.png)
  version: "1.0", // Version control (do not modify manually)

  // OAuth2 credentials (ensure these are your own)
  client_id: "xxxx...", // Google OAuth2 Client ID
  client_secret: "xxxx...", // Google OAuth2 Client Secret
  refresh_token: "xxxxxx...", // OAuth2 Refresh Token
   ...
   * [id]: Folder ID (can be 'root' for personal drive root or a Team Drive/subfolder ID)
   * [name]: Display name in the UI
   * [auth]: Optional basic authentication mapping (username: password)
   * [protect_file_link]: Whether to enable basic auth protection on file links (default: false)
   *
   * Notes:
   * - Basic Auth protects all subdirectories by default.
   * - File links are publicly accessible unless protection is enabled.
   * - Subfolder IDs do not support search functionality.
   */
  roots: [
    {
      id: "root",
  ...
  // Whether to allow users to download files flagged as potentially harmful by Google Drive
  enable_virus_infected_file_down: false,

  // Enable sorting file lists by modified date
  sort_by_modified_time: false,

  // Include files that have been moved to trash in listings
  include_trashed_files: false,

  // Force immediate directory load (may increase API usage)
  force_list_to_load: true,

  /**
   * File listing configuration for directory views
   * Recommended: 100–1000
   * Values above 1000 will cause Drive API errors
   */
  files_list_page_size: 500,

  /**
   * File listing configuration for search results
   * Recommended: 50–1000
   * A lower value may impact scroll-based loading performance
   */
  search_result_list_page_size: 50,

  // Enable CORS headers for file download requests
  enable_cors_file_down: false,

  /**
   * Password file verification
   * If true, will check for and enforce .password files in directories
   * Adds overhead during directory listings
   */
  enable_password_file_verify: false,
};

const uiConfig = {
  theme: "material", // UI theme style. Use 'material' for modern layout (do not set to 'classic', which is deprecated)
  dark_mode: false, // Enable or disable dark mode
  title_include_drive_name: false, // Append drive name to browser tab title
  title_include_path: "", // Options: "full-path" | "current-directory" | "" (none)

  // UI tab visibility settings
  hide_actions_tab: false, // Hide tab with options like download, copy link, etc.
  hide_head_md: false, // Disable rendering of HEAD.md files
  hide_readme_md: false, // Disable rendering of README.md files

  helpURL: "xxx...", // Optional URL to help/instructions page (opens in new tab)
  footer_text: "xxxx...", // Footer text content (set empty to hide)

  // UI color scheme
  // main_color and accent_color accept any of the following Material Design palette names:
  // Options: "blue-grey", "red", "pink", "purple", "deep-purple", "indigo", "blue",
  ...
  accent_color: "blue", // Accent highlight color (affects buttons, active elements)
};
/**
 ...
 */
const exportConfig = {
  documents: "docx", // Export format for Google Docs
  spreadsheets: "xlsx", // Export format for Google Sheets
  slides: "pptx", // Export format for Google Slides
  drawings: "jpg", // Export format for Google Drawings
  jamboard: "pdf", // Export format for Google Jamboard
  forms: "html/zipped", // Export format for Google Forms
};
