...
!(function (t, e) {
  ...
  var n,
    g = (function () {
      ...
      function v(t) {
        ...
        if ("string" == typeof t) {
          ...
          if ("<" === n[0] && ">" === n[n.length - 1]) {
            var i = "div";
            0 === n.indexOf("<li") && (i = "ul"),
              0 === n.indexOf("<tr") && (i = "tbody"),
              (0 !== n.indexOf("<td") && 0 !== n.indexOf("<th")) || (i = "tr"),
              0 === n.indexOf("<tbody") && (i = "table"),
              0 === n.indexOf("<option") && (i = "select");
      ...
      v.extend({
        ...
        v.fn.extend({
            ...
            return (
              "fixed" === n.css("position")
                ...
                : ((t = n.offsetParent()),
                  ...
                  (o = "html"),
                  (i.nodeName &&
                    i.nodeName.toLowerCase() === o.toLowerCase()) ||
                    (a = t.offset()),
                  (a = {
          ...
          index: function (t) {
            return t
              ? b(t)
                ? v(t).eq(0).parent().children().get().indexOf(this[0])
                : this.get().indexOf(t)
          ...
          serializeArray: function () {
            ...
            return (
              t &&
                t.elements &&
                v([].slice.call(t.elements)).each(function () {
                  var t = v(this),
                    e = t.attr("type");
          ...
          serialize: function () {
            var n = [];
            return (
              x(this.serializeArray(), function (t, e) {
                n.push(
        ...
        x(["val", "html", "text"], function (i, t) {
          var o = { 0: "value", 1: "innerHTML", 2: "textContent" },
            e = { 0: void 0, 1: void 0, 2: null };
          v.fn[t] = function (n) {
            return void 0 === n
              ? this[0]
                ? this[0][o[i]]
        ...
        x({ Width: "width", Height: "height" }, function (r, d) {
          v.fn[d] = function (t) {
            if (void 0 !== t)
              return (
                isNaN(Number(t)) || "" === t || (t += "px"), this.css(d, t)
              );
            var e,
              n,
              i = this[0];
            if ((n = i) && n === n.window) return i["inner" + r];
            if ((e = i) && e.nodeType === e.DOCUMENT_NODE)
              return i.documentElement["scroll" + r];
            var o = v(i),
              a = 0,
              s = "width" === d;
            return (
              "ActiveXObject" in window &&
                ...
                (a =
                  parseFloat(o.css("padding-" + (s ? "left" : "top"))) +
                  parseFloat(o.css("padding-" + (s ? "right" : "bottom"))) +
                  parseFloat(
                    o.css("border-" + (s ? "left" : "top") + "-width"),
                  ) +
                  parseFloat(
                    o.css("border-" + (s ? "right" : "bottom") + "-width"),
                  )),
              parseFloat(v(i).css(d)) + a
            );
          };
        }),
          ...
          v.fn["inner" + t] = function () {
            ...
            return (
              "border-box" !== e.css("box-sizing") &&
                ((t += parseFloat(
                  e.css("padding-" + ("width" === n ? "left" : "top")),
                )),
                (t += parseFloat(
                  e.css("padding-" + ("width" === n ? "right" : "bottom")),
                ))),
              t
            );
          };
      ...
      function p(t) {
        return (
          t.mduiElementId || ((o += 1), (t.mduiElementId = o)), t.mduiElementId
        );
      }
      function h(a, t, s, r) {
        (t || "").split(" ").forEach(function (t) {
          ...
          (i = s),
          (o = r),
          (l[p(e)] || []).filter(function (t) {
            return (
              t &&
              (!n || t.e === n) &&
              (!i || t.fn.toString() === i.toString()) &&
              (!o || t.sel === o)
            );
          })).forEach(function (t) {
      ...
      v.fn.extend({
        ...
        on: function (t, n, i, e, o) {
          ...
          if (
            (b(n) || g(e) || !1 === e || ((e = i), (i = n), (n = void 0)),
            (g(i) || !1 === i) && ((e = i), (i = void 0)),
            !1 === e && (e = f),
            1 === o)
          ) {
            var s = e;
                    ...
                    (e._data = s),
                      r
                        ? v(o)
                            ...
                            .reverse()
                            .forEach(function (t) {
                              (t === e.target || v.contains(t, e.target)) &&
                                n(e, t);
                            })
                        : n(e, o);
                  }
        ...
        trigger: function (t, e) {
          ...
          return (
            ((n = i
              ? new MouseEvent(t, { bubbles: !0, cancelable: !0 })
              : new CustomEvent(t, {
                  detail: e,
                  bubbles: !0,
                  cancelable: !0,
          ...
          ajax: function (a) {
            ...
            function c(t) {
              for (var e, n, i = [], o = arguments.length - 1; 0 < o--; )
                i[o] = arguments[o + 1];
              t &&
                (t in r && (e = r[t].apply(r, i)),
                a[t] && (n = a[t].apply(a, i)),
                "beforeSend" !== t || (!1 !== e && !1 !== n) || (s = !0));
            }
            x(r, function (t, e) {
              i.indexOf(t) < 0 && (n[t] = e);
            });
            ...
            if (
              ...
              var o,
                ...
                f = k(a.url, a.jsonp + "=" + l);
              if (
                ((e.options = a), d($.ajaxStart, e), c("beforeSend", null), s)
              )
                return;
            ...
            return (
              m.open(u, a.url, a.async, a.username, a.password),
              (a.contentType || (t && !C(u) && !1 !== a.contentType)) &&
              ...
              (m.onload = function () {
                ...
                if (o)
                  if (
                    ...
                    "parsererror" !== n &&
                      (d($.ajaxSuccess, e), c("success", i, n, m));
                  } else
                    (i =
                ...
                x([r.statusCode, a.statusCode], function (t, e) {
                  e &&
                    e[m.status] &&
                    (o ? e[m.status](i, n, m) : e[m.status](m, n));
                }),
                  d($.ajaxComplete, e),
                  c("complete", m, n);
              }),
              (m.onerror = function () {
                h && clearTimeout(h),
                  d($.ajaxError, e),
                  c("error", m, m.statusText),
                  d($.ajaxComplete, e),
                  c("complete", m, "error");
              }),
              (m.onabort = function () {
                var t = "abort";
                h && ((t = "timeout"), clearTimeout(h)),
                  d($.ajaxError, e),
                  c("error", m, t),
                  d($.ajaxComplete, e),
                  c("complete", m, t);
  ...
  var i,
    ...
    p = function (t, e, n, i, o) {
      o || (o = {}), (o.inst = n);
      var a = t + ".mdui." + e;
      "undefined" != typeof jQuery && jQuery(i).trigger(a, o),
        g(i).trigger(a, o);
    };
  g.fn.extend({
    reflow: function () {
    ...
    g.extend({
      showOverlay: function (t) {
        ...
        e.length
          ? (e.data("isDeleted", 0), void 0 !== t && e.css("z-index", t))
          : (void 0 === t && (t = 2e3),
            (e = g('<div class="mdui-overlay">')
      ...
      unlockScreen: function (t) {
        ...
        1 < n
          ...
          : e.data("lockscreen-level", 0).removeClass("mdui-locked").width("");
      },
    ...
    (function () {
      ...
      function s(t, e, n, i, o) {
        ...
        s || ((s = []), a.data("mdui.mutation", s)),
          -1 === s.indexOf(t) && (s.push(t), e.call(n, i, o));
      }
      g.fn.extend({
        mutation: function () {
          return this.each(function (t, e) {
        ...
        (d.mutation = function (n, i) {
          "string" == typeof n && "function" == typeof i
            ? ((a[n] = i),
              g(n).each(function (t, e) {
                s(n, i, this, t, e);
              }))
            : g(document).mutation();
        });
    ...
    (d.Headroom = (function () {
      ...
      function t(t, e) {
        ...
        if (((n.$headroom = g(t).eq(0)), n.$headroom.length)) {
          ...
          o !== Object(o) && (n.options.tolerance = { down: o, up: o }),
            n._init();
        }
      }
      (t.prototype._init = function () {
        ...
        (t.state = "pinned"),
          t.$headroom
            .addClass(t.options.initialClass)
            .removeClass(t.options.pinnedClass + " " + t.options.unpinnedClass),
          (t.inited = !1),
          (t.lastScrollY = 0),
          t._attachEvent();
      }),
      ...
      var e = function (t) {
        "pinning" === t.state &&
          ((t.state = "pinned"), p("pinned", "headroom", t, t.$headroom)),
          "unpinning" === t.state &&
            ((t.state = "unpinned"), p("unpinned", "headroom", t, t.$headroom));
      };
      return (
  ...
  var c,
    ...
    v = (function () {
      ...
      function t(t, e, n) {
        ...
        if (
          ((i.class_item = o),
          (i.class_item_open = o + "-open"),
          (i.class_header = o + "-header"),
          (i.class_body = o + "-body"),
          (i.$collapse = g(t).eq(0)),
          i.$collapse.length)
        ) {
          ...
          if (a) return a;
          (i.options = g.extend({}, s, e || {})),
            i.$collapse.on("click", "." + i.class_header, function () {
              var t = g(this).parent("." + i.class_item);
              i.$collapse.children(t).length && i.toggle(t);
            }),
            i.$collapse.on(
              "click",
              "[mdui-" + i.ns + "-item-close]",
              function () {
                var t = g(this)
                  .parents("." + i.class_item)
                  .eq(0);
      ...
      return (
        (t.prototype.open = function (t) {
          ...
          if (!e._isOpen(n)) {
            e.options.accordion &&
              e.$collapse.children("." + e.class_item_open).each(function () {
                var t = g(this);
                t !== n && e.close(t);
              });
  ...
  return (
    ...
    (function () {
      ...
      (n.prototype.init = function () {
        ...
        (n.prototype._updateThCheckboxStatus = function () {
          var t = this,
            e = t.$thCheckbox[0];
          (e.checked = t.selectedRow === t.$tdRows.length),
            (e.indeterminate =
              t.selectedRow && t.selectedRow !== t.$tdRows.length);
        }),
        (n.prototype._updateTdCheckbox = function () {
          ...
          n.$tdRows.each(function () {
            ...
            if ((t.find(".mdui-table-cell-checkbox").remove(), n.selectable)) {
              ...
              t.hasClass("mdui-table-row-selected") &&
                ((e[0].checked = !0), n.selectedRow++),
                n._updateThCheckboxStatus(),
                e.on("change", function () {
                  e[0].checked
                    ? (t.addClass("mdui-table-row-selected"), n.selectedRow++)
                    : (t.removeClass("mdui-table-row-selected"),
                      n.selectedRow--),
                    n._updateThCheckboxStatus();
                }),
        ...
        (n.prototype._updateNumericCol = function () {
          ...
          o.$thRow.find("th").each(function (e, t) {
            (n = g(t)),
              o.$tdRows.each(function () {
                i = g(this);
                var t = n.hasClass("mdui-table-col-numeric")
                  ? "addClass"
                  : "removeClass";
    ...
    (c = {
      ...
      show: function (t, e) {
        if (2 !== t.button) {
          var n,
            i = (n = "touches" in t && t.touches.length ? t.touches[0] : t)
              .pageX,
            o = n.pageY,
            a = e.offset(),
            s = i - a.left,
            ...
            d = e.innerHeight(),
            c = e.innerWidth(),
            u = Math.max(Math.pow(Math.pow(d, 2) + Math.pow(c, 2), 0.5), 48),
            l =
              "translate3d(" +
              (c / 2 - s) +
              "px, " +
    ...
    f
        ...
        if (r.isAllow(e) && (r.register(e), e.target !== document)) {
          ...
          if (
            (n = t.hasClass("mdui-ripple")
              ? t
              : t.parents(".mdui-ripple").eq(0)).length
          ) {
            ...
            if ("touchstart" === e.type) {
              var i = !1,
                ...
                a = function (t) {
                  o && (clearTimeout(o), (o = null), c.show(e, n)),
                    i || ((i = !0), c.hide(t, n));
                };
      ...
      .on(r.unlock, r.register),
    (h = function (t, e) {
      return (
        !("object" != typeof t || null === t || void 0 === t[e] || !t[e]) &&
        t[e]
      );
    }),
    f.on(
      ...
      function (t) {
        ...
        if (
          ...
          if (
            ("focus" === i && d.addClass("mdui-textfield-focus"),
            "blur" === i && d.removeClass("mdui-textfield-focus"),
            ("blur" !== i && "input" !== i) ||
              d[o && "" !== o ? "addClass" : "removeClass"](
                "mdui-textfield-not-empty",
              ),
            d[e.disabled ? "addClass" : "removeClass"](
              "mdui-textfield-disabled",
            ),
            ("input" !== i && "blur" !== i) ||
              s ||
              (e.validity &&
                d[e.validity.valid ? "removeClass" : "addClass"](
          ...
          p &&
            ...
            (d.find(".mdui-textfield-helper").length ||
              d.find(".mdui-textfield-error").length ||
              p) &&
              d.addClass("mdui-textfield-has-bottom");
        }
      },
    ),
    f.on(
    ...
    (u = function (t) {
      ...
      i.width(f + "%"),
        n.width(100 - f + "%"),
        d && (i.css("padding-right", "6px"), n.css("padding-left", "6px")),
        o.css("left", f + "%"),
        c && u.text(l),
    ...
    (t = function (t) {
      var e = g('<div class="mdui-slider-track"></div>'),
        ...
        a = o[0].disabled;
      t[a ? "addClass" : "removeClass"]("mdui-slider-disabled"),
      ...
      r && ((s = g("<span></span>")), i.empty().append(s)),
        t.data({
          $track: e,
          $fill: n,
          $thumb: i,
    ...
    (e = '.mdui-slider input[type="range"]'),
    f
      .on("input change", e, function () {
        var t = g(this).parent();
        u(t);
      })
      .on(r.start, e, function (t) {
        r.isAllow(t) &&
          (r.register(t),
          this.disabled || g(this).parent().addClass("mdui-slider-focus"));
      })
      .on(r.end, e, function (t) {
        r.isAllow(t) &&
          (this.disabled || g(this).parent().removeClass("mdui-slider-focus"));
      })
      .on(r.unlock, e, r.register),
    (d.updateSliders = function () {
    ...
    (d.Fab = (function () {
      ...
      function t(t, e) {
        ...
        if (((n.$fab = g(t).eq(0)), n.$fab.length)) {
          ...
          if (i) return i;
          (n.options = g.extend({}, o, e || {})),
            (n.state = "closed"),
            (n.$btn = n.$fab.find(".mdui-fab")),
            (n.$dial = n.$fab.find(".mdui-fab-dial")),
            (n.$dialBtns = n.$dial.find(".mdui-fab")),
            "hover" === n.options.trigger &&
              (n.$btn.on("touchstart mouseenter", function () {
                n.open();
              }),
      ...
      return (
        (t.prototype.open = function () {
          ...
          "opening" !== n.state &&
            "opened" !== n.state &&
            (n.$dialBtns.each(function (t, e) {
              e.style["transition-delay"] = e.style[
                "-webkit-transition-delay"
              ] = 15 * (n.$dialBtns.length - t) + "ms";
            }),
            n.$dial.css("height", "auto").addClass("mdui-fab-dial-show"),
            n.$btn.find(".mdui-fab-opened").length &&
              n.$btn.addClass("mdui-fab-opened"),
            (n.state = "opening"),
            p("open", "fab", n, n.$fab),
            n.$dialBtns.eq(0).transitionEnd(function () {
              n.$btn.hasClass("mdui-fab-opened") &&
                ((n.state = "opened"), p("opened", "fab", n, n.$fab));
            }));
        }),
          ...
          "closing" !== t.state &&
            ...
            t.$dialBtns.eq(-1).transitionEnd(function () {
              t.$btn.hasClass("mdui-fab-opened") ||
                ((t.state = "closed"),
                p("closed", "fab", t, t.$fab),
                t.$dial.css("height", 0));
            }));
        }),
        (t.prototype.toggle = function () {
          var t = this;
          "opening" === t.state || "opened" === t.state
            ? t.close()
            : ("closing" !== t.state && "closed" !== t.state) || t.open();
        }),
        (t.prototype.getState = function () {
          return this.state;
        }),
    ...
    (d.Select = (function () {
        ...
        if (i.length) {
          ...
          i.hide(),
            ...
            f.on("click touchstart", function (t) {
              var e = g(t.target);
              ("opening" !== n.state && "opened" !== n.state) ||
                e.is(n.$select) ||
                g.contains(n.$select[0], e[0]) ||
                n.close();
            });
        }
      }
      t.prototype.handleUpdate = function () {
        ...
        (i.value = n.val()),
          (i.text = ""),
          (i.$items = g()),
          n.find("option").each(function (t, e) {
            var n = {
              value: e.value,
              text: e.textContent,
              disabled: e.disabled,
            ...
            i.value === n.value && ((i.text = n.text), (i.selectedIndex = t)),
              (i.$items = i.$items.add(
                g(
          ...
          (i.$selected = g(
            '<span class="mdui-select-selected">' + i.text + "</span>",
          )),
          (i.$select = g(
            '<div class="mdui-select mdui-select-position-' +
              i.options.position +
              '" style="' +
              i.$selectNative.attr("style") +
              '" id="' +
              i.uniqueID +
              '"></div>',
          )
            .show()
            .append(i.$selected)),
          (i.$menu = g('<div class="mdui-select-menu"></div>')
            .appendTo(i.$select)
            .append(i.$items)),
          g("#" + i.uniqueID).remove(),
          n.after(i.$select),
          (i.size = parseInt(i.$selectNative.attr("size"))),
          (!i.size || i.size < 0) &&
            ((i.size = i.$items.length), 8 < i.size && (i.size = 8)),
          i.$items.on("click", function () {
            if ("closing" !== i.state) {
              var t = g(this);
              if (!t.data("disabled")) {
                var e = t.data();
                i.$selected.text(e.text),
                  n.val(e.value),
                  i.$items.removeAttr("selected"),
                  t.attr("selected", ""),
                  (i.selectedIndex = e.index),
                  (i.value = e.value),
                  (i.text = e.text),
                  n.trigger("change"),
                  i.close();
      ...
      var e = function (t) {
        t.$select.removeClass("mdui-select-closing"),
          "opening" === t.state &&
            ((t.state = "opened"),
            p("opened", "select", t, t.$selectNative),
            t.$menu.css("overflow-y", "auto")),
          "closing" === t.state &&
            ((t.state = "closed"),
            p("closed", "select", t, t.$selectNative),
            t.$select.width(""),
      ...
      return (
        (t.prototype.open = function () {
          ...
          "opening" !== t.state &&
            "opened" !== t.state &&
            ((t.state = "opening"),
            p("open", "select", t, t.$selectNative),
            (function (t) {
              var e,
                n,
                i = T.height(),
                ...
                u = parseFloat(t.$select.width() + 0.01),
                l = d * t.size + 2 * c,
                f = t.$select[0].getBoundingClientRect().top;
              if ("auto" === a) {
                var p = i - 2 * o;
                p < l && (l = p),
                  (n = -(c + t.selectedIndex * d + (d - s) / 2));
        ...
        (t.prototype.close = function () {
          ...
          "closing" !== t.state &&
            "closed" !== t.state &&
            ((t.state = "closing"),
            p("close", "select", t, t.$selectNative),
    ...
    g(function () {
      d.mutation("[mdui-select]", function () {
        ...
        e ||
          ((e = new d.Select(t, s(t.attr("mdui-select")))),
          t.data("mdui.select", e));
      });
    }),
    g(function () {
    ...
    (d.Tab = (function () {
      ...
      function t(t, e) {
        ...
        if (((n.$tab = g(t).eq(0)), n.$tab.length)) {
          ...
          var o = location.hash;
          o &&
            n.$tabs.each(function (t, e) {
              if (g(e).attr("href") === o) return (n.activeIndex = t), !1;
            }),
            !1 === n.activeIndex &&
              n.$tabs.each(function (t, e) {
                if (g(e).hasClass("mdui-tab-active"))
                  return (n.activeIndex = t), !1;
              }),
            n.$tabs.length && !1 === n.activeIndex && (n.activeIndex = 0),
            n._setActive(),
            T.on(
              "resize",
              g.throttle(function () {
      ...
      return (
        (t.prototype._bindTabEvent = function (e) {
          var n = this,
            i = g(e),
            t = function (t) {
              s(i)
                ? t.preventDefault()
                : ((n.activeIndex = n.$tabs.index(e)), n._setActive());
            };
          i.on("click", t),
            "hover" === n.options.trigger && i.on("mouseenter", t),
        ...
        (t.prototype._setActive = function () {
          ...
          o.$tabs.each(function (t, e) {
            var n = g(e),
              i = n.attr("href");
            t !== o.activeIndex || s(n)
              ? (n.removeClass("mdui-tab-active"), g(i).hide())
              : (n.hasClass("mdui-tab-active") ||
                  (p("change", "tab", o, o.$tab, {
                    index: o.activeIndex,
                    id: i.substr(1),
                  }),
                  p("show", "tab", o, n),
              ...
              s(t) ||
                ...
                n.$indicator.css({
                  left:
                    e.left +
                    n.$tab[0].scrollLeft -
                    n.$tab[0].getBoundingClientRect().left +
                    "px",
                  width: t.width() + "px",
                })))
        ...
        (t.prototype.next = function () {
          var t = this;
          !1 !== t.activeIndex &&
            (t.$tabs.length > t.activeIndex + 1
              ? t.activeIndex++
              : t.options.loop && (t.activeIndex = 0),
            t._setActive());
        }),
        (t.prototype.prev = function () {
          ...
          !1 !== t.activeIndex &&
            (0 < t.activeIndex
              ? t.activeIndex--
              : t.options.loop && (t.activeIndex = t.$tabs.length - 1),
            t._setActive());
        }),
    ...
    (d.Drawer = (function () {
      ...
      function t(t, e) {
        ...
        if (((n.$drawer = g(t).eq(0)), n.$drawer.length)) {
          ...
          (n.options = g.extend({}, o, e || {})),
            (n.overlay = !1),
            (n.position = n.$drawer.hasClass("mdui-drawer-right")
              ? "right"
              : "left"),
            n.$drawer.hasClass("mdui-drawer-close")
              ? (n.state = "closed")
              : n.$drawer.hasClass("mdui-drawer-open")
                ? (n.state = "opened")
                : a()
                  ? (n.state = "opened")
                  : (n.state = "closed"),
            T.on(
              ...
              g.throttle(function () {
                a()
                  ? (n.overlay &&
                      !n.options.overlay &&
                      (g.hideOverlay(), (n.overlay = !1), g.unlockScreen()),
                    n.$drawer.hasClass("mdui-drawer-close") ||
                      (n.state = "opened"))
                  : n.overlay ||
                    "opened" !== n.state ||
                    (n.$drawer.hasClass("mdui-drawer-open")
                      ? (g.showOverlay(),
                        (n.overlay = !0),
                        g.lockScreen(),
                        g(".mdui-overlay").one("click", function () {
                          n.close();
                        }))
                      : (n.state = "closed"));
              }, 100),
            ),
            n.$drawer.find("[mdui-drawer-close]").each(function () {
            ...
            (function (a) {
              ...
              function f(t, e) {
                ...
                a.$drawer.css(
                  ...
                  "transform:" +
                    i +
                    (e ? "transition: initial !important;" : ""),
                );
              }
              function o() {
              ...
              function h(t) {
                return Math.min(
                  Math.max("closing" === c ? d - t : p() + d - t, 0),
                  p(),
                );
              }
              function i(t) {
                (s = t.touches[0].pageX),
                  "right" === a.position && (s = l.width() - s),
                  (r = t.touches[0].pageY),
                  ("opened" !== a.state && (n < s || e !== i)) ||
                    ((u = !0),
                    l.on({ touchmove: m, touchend: v, touchcancel: m }));
              }
              function m(t) {
                ...
                if (c) f(h(e), !0);
                  ...
                  8 < i && o <= 8
                    ? ((d = e),
                      (c = "opened" === a.state ? "closing" : "opening"),
                      g.lockScreen(),
                      f(h(e), !0))
                    : i <= 8 && 8 < o && v();
                }
      ...
      var e = function (t) {
        t.$drawer.hasClass("mdui-drawer-open")
          ? ((t.state = "opened"), p("opened", "drawer", t, t.$drawer))
          : ((t.state = "closed"), p("closed", "drawer", t, t.$drawer));
      };
      return (
        (t.prototype.open = function () {
          var t = this;
          "opening" !== t.state &&
            "opened" !== t.state &&
            ((t.state = "opening"),
            p("open", "drawer", t, t.$drawer),
            t.options.overlay ||
              g("body").addClass("mdui-drawer-body-" + t.position),
            t.$drawer
            ...
            (a() && !t.options.overlay) ||
              ((t.overlay = !0),
              g.showOverlay().one("click", function () {
                t.close();
              }),
              g.lockScreen()));
        }),
        (t.prototype.close = function () {
          ...
          "closing" !== t.state &&
            "closed" !== t.state &&
            ((t.state = "closing"),
            p("close", "drawer", t, t.$drawer),
            t.options.overlay ||
              g("body").removeClass("mdui-drawer-body-" + t.position),
            t.$drawer
    ...
    g(function () {
      d.mutation("[mdui-drawer]", function () {
        ...
        o || ((o = new d.Drawer(i, e)), i.data("mdui.drawer", o)),
          t.on("click", function () {
            o.toggle();
          });
      });
    ...
    (d.Dialog = (function () {
      var n,
        ...
        r = function () {
          if (a) {
            ...
            t.height(""), n.height("");
            var o = t.height();
            t.css({ top: (T.height() - o) / 2 + "px", height: o + "px" }),
      ...
      var u = function (t) {
        t.$dialog.hasClass("mdui-dialog-open")
          ? ((t.state = "opened"), p("opened", "dialog", t, t.$dialog))
          : ((t.state = "closed"),
            p("closed", "dialog", t, t.$dialog),
            t.$dialog.hide(),
            0 === l.queue(s).length && !a && i && (g.unlockScreen(), (i = !1)),
            T.off(
              "resize",
              g.throttle(function () {
                r();
      ...
      return (
        (t.prototype._doOpen = function () {
          ...
          if (
            ...
            (t.state = "opening"),
            p("open", "dialog", t, t.$dialog),
            t.$dialog.addClass("mdui-dialog-open").transitionEnd(function () {
              u(t);
            }),
            n || (n = g.showOverlay(5100)),
            n[t.options.modal ? "off" : "on"]("click", c).css(
              "opacity",
              t.options.overlay ? "" : 0,
            ),
            t.options.history)
        ...
        (t.prototype.open = function () {
          ...
          "opening" !== t.state &&
            "opened" !== t.state &&
            ((a && ("opening" === a.state || "opened" === a.state)) ||
            l.queue(s).length
              ? l.queue(s, function () {
                  t._doOpen();
                })
        ...
        (t.prototype.close = function () {
          ...
          setTimeout(function () {
            "closing" !== t.state &&
              ...
              ((a = null),
              (t.state = "closing"),
              p("close", "dialog", t, t.$dialog),
              0 === l.queue(s).length && n && (g.hideOverlay(), (n = null)),
              t.$dialog
              ...
              t.options.history &&
                0 === l.queue(s).length &&
                (e[0] || window.history.back(), T.off("hashchange", d)),
              setTimeout(function () {
                l.dequeue(s);
              }, 100));
          }, 0);
        ...
        (t.prototype.destroy = function () {
          this.append && this.$dialog.remove(),
            ...
            0 !== l.queue(s).length ||
              a ||
              (n && (g.hideOverlay(), (n = null)),
              i && (g.unlockScreen(), (i = !1)));
        }),
        (t.prototype.handleUpdate = function () {
          r();
        }),
    ...
    (d.dialog = function (n) {
      var i = { text: "", bold: !1, close: !0, onClick: function (t) {} };
      (n = g.extend(
        {},
        {
          title: "",
          ...
          a.$dialog
            ...
            .each(function (t, e) {
              g(e).on("click", function () {
                "function" == typeof n.buttons[t].onClick &&
                  n.buttons[t].onClick(a),
                  n.buttons[t].close && a.close();
              });
            }),
        "function" == typeof n.onOpen &&
          a.$dialog
    ...
    (d.confirm = function (t, e, n, i, o) {
      "function" == typeof e &&
        ((e = ""), (n = arguments[1]), (i = arguments[2]), (o = arguments[3])),
        void 0 === n && (n = function () {}),
        void 0 === i && (i = function () {}),
        void 0 === o && (o = {});
      return (
        ...
        d.dialog({
          ...
          content: t,
          buttons: [
            { text: o.cancelText, bold: !1, close: !0, onClick: i },
            { text: o.confirmText, bold: !1, close: !0, onClick: n },
          ],
    ...
    (d.prompt = function (t, e, i, n, o) {
      "function" == typeof e &&
        ((e = ""), (i = arguments[1]), (n = arguments[2]), (o = arguments[3])),
        void 0 === i && (i = function () {}),
        void 0 === n && (n = function () {}),
        void 0 === o && (o = {});
      var a =
      ...
      return (
        ...
        d.dialog({
          ...
          content: a,
          buttons: [
            { text: o.cancelText, bold: !1, close: !0, onClick: s },
            { text: o.confirmText, bold: !1, close: !0, onClick: r },
          ],
    ...
    (d.Tooltip = (function () {
      ...
      function i(t) {
        ...
        switch (
          ...
          -1 === ["bottom", "top", "left", "right"].indexOf(i) &&
            (i =
              o.top + o.height + a + r + 2 < T.height()
                ? "bottom"
                : a + r + 2 < o.top
                  ? "top"
                  : a + s + 2 < o.left
                    ? "left"
                    : o.width + a + s + 2 < T.width() - o.left
                      ? "right"
                      : "bottom"),
          i)
        ) {
      ...
      var e = function (t) {
        t.$tooltip.hasClass("mdui-tooltip-open")
          ? ((t.state = "opened"), p("opened", "tooltip", t, t.$target))
          : ((t.state = "closed"), p("closed", "tooltip", t, t.$target));
      };
      return (
        (t.prototype._doOpen = function () {
          var t = this;
          (t.state = "opening"),
            p("open", "tooltip", t, t.$target),
        ...
        (t.prototype.open = function (t) {
          ...
          if ("opening" !== e.state && "opened" !== e.state) {
            ...
            g.extend(e.options, s(e.$target.attr("mdui-tooltip"))),
              t && g.extend(e.options, t),
              n.content !== e.options.content &&
                e.$tooltip.html(e.options.content),
              i(e),
              e.options.delay
                ? (e.timeoutId = setTimeout(function () {
                    e._doOpen();
                  }, e.options.delay))
                : ((e.timeoutId = !1), e._doOpen());
          }
        }),
        (t.prototype.close = function () {
          var t = this;
    ...
    (function () {
      ...
      function s(t, e) {
        var n = this;
        if (
          ((n.message = t), (n.options = g.extend({}, a, e || {})), n.message)
        ) {
          (n.state = "closed"), (n.timeoutId = !1);
          var i = "",
            o = "";
          0 === n.options.buttonColor.indexOf("#") ||
          0 === n.options.buttonColor.indexOf("rgb")
            ? (i = 'style="color:' + n.options.buttonColor + '"')
            : "" !== n.options.buttonColor &&
              (o = "mdui-text-color-" + n.options.buttonColor),
            (n.$snackbar = g(
            ...
            n._setPosition("close"),
            n.$snackbar
              .reflow()
              .addClass("mdui-snackbar-" + n.options.position);
        }
      }
      (s.prototype._setPosition = function (t) {
                ...
                e.$snackbar.transitionEnd(function () {
                  "opening" === e.state &&
                    ...
                    e.$snackbar.on("click", function (t) {
                      g(t.target).hasClass("mdui-snackbar-action") ||
                        e.options.onClick();
                    }),
                    e.options.closeOnOutsideClick && f.on(r.start, o),
                    e.options.timeout &&
                      (e.timeoutId = setTimeout(function () {
                        e.close();
                      }, e.options.timeout)));
        ...
        (s.prototype.close = function () {
          ...
          t.message &&
            ...
            t.options.closeOnOutsideClick && f.off(r.start, o),
            (t.state = "closing"),
            t.options.onClose(),
    ...
    f.on("click", ".mdui-bottom-nav>a", function () {
      ...
      o.children("a").each(function (t, e) {
        (n = i.is(e)) && p("change", "bottomNav", null, o, { index: t }),
    ...
    (d.Menu = (function () {
      var a = {
        ...
        s = function (t) {
          ...
          if (
            ...
            (s = "100%"), (n = (u ? b : 0) + (l ? v - p : $ - p));
          else {
            s = "50%";
            var k = p;
            t.isCascade ||
              (r < p + 2 * c && ((k = r - 2 * c), t.$menu.height(k))),
              (n = (r - k) / 2 + (l ? 0 : $ - v));
          }
          if ((t.$menu.css("top", n + "px"), "left" === o))
            ...
            a = "50%";
            var O = f;
            d < f + 2 * c && ((O = d - 2 * c), t.$menu.width(O)),
              (e = (d - O) / 2 + (l ? 0 : C - g));
          }
        ...
        u = function (t) {
          ...
          (d = (e = t).parent(".mdui-menu-item")),
            (c = T.height()),
            (u = T.width()),
            (l = e.width()),
            (f = e.height()),
            (p = d[0].getBoundingClientRect()),
            (h = p.width),
            (m = p.height),
            (v = p.left),
            (g = p.top),
            (a = l < u - v - h ? "left" : l < v ? "right" : "left"),
            "bottom" ==
            (o = f < c - g ? "bottom" : f < g + m ? "top" : "bottom")
              ? (n = r = "0")
              : "top" === o && ((r = "100%"), (n = -f + m)),
            e.css("top", n + "px"),
            "left" === a
        ...
        r = function (r) {
          ...
          (r.$menu.on("click", ".mdui-menu-item", function (t) {
            ...
            if (
              ...
              !n.is(".mdui-menu") &&
              !n.is(".mdui-divider") &&
              n.parents(".mdui-menu-item").eq(0).is(e)
            ) {
              var i,
          ...
          "hover" === r.options.subMenuTrigger) &&
            r.$menu.on("mouseover mouseout", ".mdui-menu-item", function (t) {
              var e = g(this),
                n = t.type,
                i = g(t.relatedTarget);
              if (null === e.attr("disabled")) {
                ...
                if ("mouseover" === n) {
                  if (o.length) {
                    ...
                    if ((a && clearTimeout(a), o.hasClass("mdui-menu-open")))
                      return;
                    clearTimeout(c),
                      (d = c =
                        setTimeout(function () {
                          u(o);
                        }, r.options.subMenuDelay)),
                      o.data("timeoutOpen.mdui.menu", d);
                  }
                  ...
                  s && clearTimeout(s),
                    ...
                    o.data("timeoutClose.mdui.menu", d);
                }
              }
            });
        };
      function t(t, e, n) {
        ...
        if (((i.$anchor = g(t).eq(0)), i.$anchor.length)) {
          ...
          if (o) return o;
          (i.$menu = g(e).eq(0)),
            i.$anchor.siblings(i.$menu).length &&
              ((i.options = g.extend({}, a, n || {})),
              (i.state = "closed"),
              (i.isCascade = i.$menu.hasClass("mdui-menu-cascade")),
              "auto" === i.options.covered
                ? (i.isCovered = !i.isCascade)
                : (i.isCovered = i.options.covered),
              ...
              f.on("click touchstart", function (t) {
                ...
                ("opening" !== i.state && "opened" !== i.state) ||
                  e.is(i.$menu) ||
                  g.contains(i.$menu[0], e[0]) ||
                  e.is(i.$anchor) ||
                  g.contains(i.$anchor[0], e[0]) ||
                  i.close();
              }),
      ...
      var e = function (t) {
        t.$menu.removeClass("mdui-menu-closing"),
          "opening" === t.state &&
            ((t.state = "opened"), p("opened", "menu", t, t.$menu)),
          "closing" === t.state &&
            ((t.state = "closed"),
            p("closed", "menu", t, t.$menu),
